...
public class LoginSteps extends Config {
    ...
    public void userEnterValidEmailAddress() {lp.enterEmailAddress(TestData.username);
    }

    @And("user enter valid password")
    public void userEnterValidPassword() {lp.enterPassword(TestData.password);
    }

    @When("user clicks on Log In button")
    public void userClicksOnLogInButton() { lp.clickOnLoginButton();
    }
...
//        lp.enterEmailAddress("fakeemail19@gmail.com");
//    }
//
//    @And("login")
//    public void login() {
